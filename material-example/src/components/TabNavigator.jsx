...
const TabNavigator = () => {
  ...
  const toggleVisibility4 = () => { setIsVisible4(!isVisible4); };
  const toggleVisibility5 = () => { setIsVisible5(!isVisible5); };
  const toggleVisibility6 = () => { setIsVisible6(!isVisible6); };
  const toggleVisibility7 = () => { setIsVisible7(!isVisible7); };
  const toggleVisibility8 = () => { setIsVisible8(!isVisible8); };
  const toggleVisibility9 = () => { setIsVisible9(!isVisible9); };
  const toggleVisibility10 = () => { setIsVisible10(!isVisible10); };
  const toggleVisibility11 = () => { setIsVisible11(!isVisible11); };
  const toggleVisibility12 = () => { setIsVisible12(!isVisible12); };
  const toggleVisibility13 = () => { setIsVisible13(!isVisible13); };
  const toggleVisibility14 = () => { setIsVisible14(!isVisible14); };
  const toggleVisibility15 = () => { setIsVisible15(!isVisible15); };
  const toggleVisibility16 = () => { setIsVisible16(!isVisible16); };
  const toggleVisibility17 = () => { setIsVisible17(!isVisible17); };
  const toggleVisibility18 = () => { setIsVisible18(!isVisible18); };
  const toggleVisibility19 = () => { setIsVisible19(!isVisible19); };
  const toggleVisibility20 = () => { setIsVisible20(!isVisible20); };
  const toggleVisibility21 = () => { setIsVisible21(!isVisible21); };
  ...
  const toggleVisibility25 = () => { setIsVisible25(!isVisible25); };
  ...
  return (
    <Tab.Navigator
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarGap: isVisible15 ? 10 : undefined,
        ...
        tabBarIconStyle: isVisible21 ? { backgroundColor: "blue" } : undefined,
        tabBarLabelStyle: isVisible22
          ? { fontSize: 12, color: "green" }
          : undefined,
        tabBarItemStyle: isVisible23 ? { width: 100 } : undefined,
